...
(defn collection
  [name]
  (str "com.etzhayyim.kenchi." name))

(def cell-specs {
  :kenchi_ingest {:legacy-cell "kenchi-ingest"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kenchi_ingest")]
     :required-gates common-gates
     :trigger "manifest cell kenchi_ingest"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :kenchi_fusion {:legacy-cell "kenchi-fusion"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kenchi_fusion")]
     :required-gates common-gates
     :trigger "manifest cell kenchi_fusion"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :kenchi_provenance_governor {:legacy-cell "kenchi-provenance-governor"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kenchi_provenance_governor")]
     :required-gates common-gates
     :trigger "manifest cell kenchi_provenance_governor"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :kenchi_publish {:legacy-cell "kenchi-publish"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kenchi_publish")]
     :required-gates common-gates
     :trigger "manifest cell kenchi_publish"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :kenchi_region_aggregate {:legacy-cell "kenchi-region-aggregate"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kenchi_region_aggregate")]
     :required-gates common-gates
     :trigger "manifest cell kenchi_region_aggregate"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :kenchi_flywheel {:legacy-cell "kenchi-flywheel"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kenchi_flywheel")]
     :required-gates common-gates
     :trigger "manifest cell kenchi_flywheel"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
